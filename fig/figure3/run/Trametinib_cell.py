...
data = data[data['drug'] == 'Trametinib']
...
# 创建柱状图
bars = plt.bar(cell_lines, predicted_auc, color='#3274A1', width=0.6)#0D8AB1
...
plt.ylim(0.33, 0.54)
plt.yticks(np.arange(0.35, 0.51, 0.05), fontsize=26)
...
# 添加标题框
rect_title = plt.Rectangle((-1, 0.51), len(cell_lines)+1, 2, linewidth=3, edgecolor='black', facecolor='#D0D7DB')
plt.gca().add_patch(rect_title)
plt.text(2.1, 0.52, r'Trametinib',
...
# plt.show()
plt.savefig('../fig/Trametinib_bio.png', bbox_inches='tight')