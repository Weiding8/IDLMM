...
con_list = []
mu_list = []
con_data = open("../data/drug_pearson_drugcell_transEncoder1408_JZ.txt")#drug_pearson_drugcell_transEncoder.txt"
...
con_data.close()
# *******
mu_data = open("../data/drug_pearson_druggene.txt")
...
plt.xlabel(u'Pearson correlation (DrugGene) ', fontsize=40)
plt.ylabel(u'Pearson correlation (IDLMM) ', fontsize=40)#, labelpad=15

plt.xticks([0.0, 0.5, 1.0], [0.0, 0.5, 1.0], fontsize=34)
plt.yticks([0.0, 0.5, 1.0], [0.0, 0.5, 1.0], fontsize=34)
# plt.xticks([-0.5, 0.0, 0.5], [-0.5, 0.0, 0.5], fontsize=30)
# plt.yticks([-0.5, 0.0, 0.5], [-0.5, 0.0, 0.5], fontsize=30)
...
plt.savefig('../fig/desity_drruggene.png', bbox_inches='tight')
