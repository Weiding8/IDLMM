...
predictions = predictions[predictions['project'] == 'TCGA-LGG']
...
plt.title('Survival Analysis for LGG in TCGA', fontsize=26)
plt.xlabel('Days',fontsize=26)
plt.ylabel('Survival Probability',fontsize=26)
plt.xlim(0, 3000)
plt.axhline(y=0.5, color='gray', linestyle='--')
plt.text(2000, 0.3, f'p =  {p_value:.5f}', horizontalalignment='center', verticalalignment='center',fontsize=24)
# plt.legend()
# plt.grid()
...
# Show the plot
# plt.show()
plt.savefig('../fig/LGG_id2.png', bbox_inches='tight')